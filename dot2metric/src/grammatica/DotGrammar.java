...
public class DotGrammar implements DotGrammarConstants {
 ...
 // public ArrayList<String> lista_metodi_chiamati = new ArrayList<>();
  ...
  final public String test() throws ParseException {
  Token t1,t2;
  ...
  final public void test2() throws ParseException {
    jj_consume_token(NODE);
                  System.out.println("NODO");
  }

  final public void test3() throws ParseException {
    jj_consume_token(PARENTESI_GRAFFA_APERTA);
                                      System.out.println("PARENTESI GRAFFA");
    jj_consume_token(NODE);
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x44000,0x44000,};
   }
